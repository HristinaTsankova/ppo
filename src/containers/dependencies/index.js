...
const fakeOrder = {
  ...
  "name": "болеро с бие",
  "model": "2427-1",
  "identification_number": "кл:14:/пор:46",
  "client_name": "Андроид",
  "client_model": "IGLOO-TIBET",
  "client_identification_number": "тест 2",
  "order_distributions": [
    {
      "id": 240,
      "size": "4",
  ...
  "order_processes": [
    {
      "id": 553,
      "name": "ПРИКАЧВА БИЕ ПО ПОДГЪВ РЪКАВИ, РЕЖЕ",
      "serial_number": 3,
      "aligned_time": 2.6,
      "separate": false,
      "machine_type": {
      ...
      "id": 552,
      "name": "СГЛОБЯВА РАМА С ЛАСЕ Х 2, МЕРИ СИМЕТРИЯ",
      "serial_number": 2,
      "aligned_time": 1.8,
      "separate": false,
      "machine_type": {
      ...
      "id": 564,
      "name": "ОПАКОВКА, СТРЕЛЯ ЕТИКЕТ, СГЪВА ПО КАРТОН, СЛАГА В ПЛИК, ЗАСИЧА ПО ЗАДАНИЕ, ПОДРЕЖДА В КАШОНИ",
      "serial_number": 14,
      "aligned_time": 1.9,
      "separate": false,
      "machine_type": {
      ...
      "id": 561,
      "name": "МЕРИ СРЕДА И ПРИКАЧВА ФИРМЕНА МАРКА С РАЗМЕР НА ВРАТНА ИЗВИВКА",
      "serial_number": 11,
      "aligned_time": 0.9,
      "separate": false,
      "machine_type": {
      ...
      "id": 560,
      "name": "ЗАГЪВА КОНЕЦ И ЗАТЯГА БИЕТА Х 4",
      "serial_number": 10,
      "aligned_time": 2.4,
      "separate": false,
      "machine_type": {
      ...
      "id": 559,
      "name": "СГЛОБЯВА СТРАНИЧЕН ШЕВ, РЕЖЕ МАРКА ОТ ЛЕНТА, БЕЛЕЖИ И ПОСТАВЯ",
      "serial_number": 9,
      "aligned_time": 2.0,
      "separate": false,
      "machine_type": {
      ...
      "id": 558,
      "name": "ЗАТЯГА БИЕТА ПРИ ПОДГЪВ РЪКАВИ Х 2",
      "serial_number": 8,
      "aligned_time": 0.8,
      "separate": false,
      "machine_type": {
      ...
      "id": 557,
      "name": "ПРИКАЧВА РЪКАВИ НА ОТВОРЕН СТРАНИЧЕН ШЕВ",
      "serial_number": 7,
      "aligned_time": 2.4,
      "separate": false,
      "machine_type": {
      ...
      "id": 556,
      "name": "ЗАТЯГА БИЕТА ПРИ ПОДГЪВ ТЯЛО Х 2",
      "serial_number": 6,
      "aligned_time": 0.8,
      "separate": false,
      "machine_type": {
      ...
      "id": 555,
      "name": "ПРИКАЧВА БИЕ ПО ПОДГЪВ ПРЕДНИ ЧАСТИ, БОРД И ВРАТНА ИЗВИВКА, РЕЖЕ, ВНИМАВА НА ИЗВИВКИТЕ",
      "serial_number": 5,
      "aligned_time": 5.0,
      "separate": false,
      "machine_type": {
      ...
      "id": 554,
      "name": "ПРИКАЧВА БИЕ ПО ПОДГЪВ ГРЪБ, РЕЖЕ",
      "serial_number": 4,
      "aligned_time": 1.6,
      "separate": false,
      "machine_type": {
  ...
  "departments": [
    {
      "id": 2,
      "name": "Цех 1",
      "type": "TailorDepartment",
      "users": [
        {
          "id": 3,
          "name": "Ася Колибаровска",
          "department_id": 2,
          "roles": ["Шивач"]
        }, {
          "id": 4,
          ...
          "id": 15,
          "name": "Пробен таблет 1",
          "department_id": 2,
          "roles": ["Шивач"]
        }, {
          "id": 16,
          "name": "пробен таблет 2",
          "department_id": 2,
          "roles": ["Шивач"]
        }, {
          "id": 2,
